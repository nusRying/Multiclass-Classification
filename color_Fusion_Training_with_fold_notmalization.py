...
def run_cv(
    ...
    for params in param_grid:
        ...
        for fold, (tr_idx, te_idx) in enumerate(skf.split(X, y), start=1):
            ...
            # =================================================
            # FOLD-WISE NORMALIZATION (CORRECT)
            # =================================================
    ...
    folds_path = os.path.join(
        out_dir,
        f"exstracs_{dataset_name}_{feature_set_name}_foldnorm_folds_{ts}.jsonl"
    )
    summary_path = os.path.join(
        out_dir,
        f"exstracs_{dataset_name}_{feature_set_name}_foldnorm_summary_{ts}.json"
    )
...
# =====================================================
# MAIN: RAW FEATURE + FOLD-NORM EXPERIMENTS
# =====================================================
...
if __name__ == "__main__":
    ...
    experiments = [
        ("ham10000_color_raw.csv", "HAM10000", "Color"),
        ("isic2019_color_raw.csv", "ISIC2019", "Color"),
    ]

    out_dir = os.path.join(PROJECT_ROOT, "lcs", "color_foldnorm")
    all_runs = []
    ...
    final_out = os.path.join(
        out_dir,
        f"exstracs_raw_foldnorm_feature_comparison_"
